...
const TileWrapper = ({ element }: { element: FormElemetInstance }) => {
  ...
  return (
    <div
      ...
      className="relative group bg-white backdrop-blur-md rounded-lg border-2 border-gray-200 shadow-sm hover:shadow-md transition-all cursor-pointer whitespace-nowrap"
