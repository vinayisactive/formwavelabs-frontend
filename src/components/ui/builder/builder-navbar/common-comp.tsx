...
export const Breadcrumb = ({ workspaceId, workspaceName, formTitle }: { 
  workspaceId: string | undefined;
  workspaceName: string | undefined;
  formTitle: string | undefined;
}) => (
  <div className="flex items-center text-xs text-black h-full md:border px-2 py-2 rounded-lg md:shadow-inner shadow-none">
